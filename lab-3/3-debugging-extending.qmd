...
<li>Now reopen your L3-NumberGuessing project. Make sure your version doesn't have the same bug.</li>

</ol>
:::

<h2>Extending the Program with More Specific Responses</h2>

::: forYouToDo
<ol start="3">

<li>Use more conditional blocks and predicates to make the computer tell the player whether a guess is<b> too big or too small</b>: "That's too big. Try again." <br /><img src="/img/icons/talk-with-your-partner.png" title="Talk with Your Partner" alt="Talk with Your Partner" class="inline"/> Where in the code should these conditionals go?</li>
