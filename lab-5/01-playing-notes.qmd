...
<a class="js-run snap-project" href="/prog/U2/lab01/sample-song-player-mary-lamb.xml" title="Sample Song Player: Mary Had a Little Lamb - Snap! project" target="_blank">Mary Had a Little Lamb</a></li>
		...
		<div class="learn">In this activity, you <em>connected</em> several <em>command</em> blocks together to create a song.</div>
