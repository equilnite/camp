...
<li>Check out <a class="js-run snap-project" href="/prog/lab-5/new/musical-improvisation-from-Jens.xml" target="_blank">Jens' project</a>. As of March 2022, need to open it in <a href="https://snap.berkeley.edu/versions/dev" target="_blank">the current dev version</a>.</li>
