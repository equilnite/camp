...
<li>Make sure you are logged in to Snap<em>!</em> so you can save your work.</li>

<li>

<a href="/prog/L1-ClickAlonzo.xml" class="run"><img src="/img/icons/load-save.png" title="Click here to load this file. Then save it to your Snap! account." alt="Click here to load this file. Then save it to your Snap! account." class="inline"/></a>
