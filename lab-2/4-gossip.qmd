...
<li><a href="/prog/1-introduction/L2-Gossip.xml" class="run"><img src="/img/icons/load-save.png" title="Click here to load this file. Then save it to your Snap! account." alt="Click here to load this file. Then save it to your Snap! account." class="inline"/></a></li>
...
<li>What does each <em>variable</em> report?<br /> <img src="/img/1-introduction/who.png" title="who block" alt="who block" class="indent"/> <img src="/img/1-introduction/does-what.png" title="does what block" alt="does what block" class="inline"/> 
</li>
<ul>
<li>
